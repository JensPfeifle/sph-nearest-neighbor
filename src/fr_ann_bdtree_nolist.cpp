...
int main(int argc, char **argv)
{
	...
	bdTree = new ANNbd_tree( // build search structure
	...
	for (int i = 0; i < nDataPts; i++)
	{
		...
		const int nNeighbors = bdTree->annkFRSearch(
		...
		bdTree->annkFRSearch( //run again to get neighbors
			queryPt,		  // ANNpoint query point
			rSq,			  // squared radius
		...
		/* SKIP INTERACTION LIST GENERATION
