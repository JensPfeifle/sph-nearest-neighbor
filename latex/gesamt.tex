...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\doctitle}{Implementation of a Nearest-Neighbor Search for Particle-Based Simulations in Sparsely-Filled Computational Domains} 				% Titel der Arbeit
\newcommand{\doctype}{Energietechnisches Praktikum}			% Dokumenttyp
\newcommand{\docauthor}{Jens Pfeifle, B.Sc.}	% Autor
...
% Hauptteil
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{kapitel/elab_einleitung.tex}
\input{kapitel/elab_searchmethods.tex}
\input{kapitel/elab_structure.tex}
\input{kapitel/elab_testcases.tex}
\input{kapitel/elab_results.tex}
\input{kapitel/elab_summary.tex}

%\input{kapitel/elabor.tex}
